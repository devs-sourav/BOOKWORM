...
const sampleAuthors = [
  ...
  },
  {
    ...
    name: "Andre Aciman",
    slug: "andre-aciman",
    image: "https://images.unsplash.com/photo-1603415526960-f7e0328fddb5?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    name: "Bella Forrest",
    slug: "bella-forrest",
    image: "https://images.unsplash.com/photo-1552058544-5c9f5fe3b1af?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1524503033411-c9566986fc8f?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    name: "Dan Brown",
    slug: "dan-brown",
    image: "https://images.unsplash.com/photo-1552058544-8465c729e7a0?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1522199778947-0c7f1b5f32a6?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    name: "Jane Austen",
    slug: "jane-austen",
    image: "https://images.unsplash.com/photo-1502720705749-3c045fa5d5da?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    name: "John Green",
    slug: "john-green",
    image: "https://images.unsplash.com/photo-1546456073-6712f79251bb?auto=format&fit=crop&w=500&q=80",
    publishedBooksCount: 6,
  },
  {
    id: 21,
    ...
    image: "https://images.unsplash.com/photo-1520813792240-56fc4a3765a7?auto=format&fit=crop&w=500&q=80",
    publishedBooksCount: 3,
  },
  {
    id: 22,
  ...
  },
  {
    ...
    name: "Lisa Jewell",
    slug: "lisa-jewell",
    image: "https://images.unsplash.com/photo-1554384645-13eab165c24b?auto=format&fit=crop&w=500&q=80",
    publishedBooksCount: 6,
  },
  {
    id: 24,
  ...
  },
  {
    ...
    name: "Nora Roberts",
    slug: "nora-roberts",
    image: "https://images.unsplash.com/photo-1535930749574-1399327ce78f?auto=format&fit=crop&w=500&q=80",
  ...
  },
  {
    ...
    name: "Rainbow Rowell",
    slug: "rainbow-rowell",
    image: "https://images.unsplash.com/photo-1554151228-14d9def656e4?auto=format&fit=crop&w=500&q=80",
    publishedBooksCount: 4,
  },
  {
    id: 29,
    name: "Rick Riordan",
    slug: "rick-riordan",
    image: "https://images.unsplash.com/photo-1520975918318-b9162edab2a8?auto=format&fit=crop&w=500&q=80",
    publishedBooksCount: 13,
  },
  {
    id: 30,
  ...
  },
  {
    ...
    name: "Tana French",
    slug: "tana-french",
    image: "https://images.unsplash.com/photo-1544717305-996b815c338c?auto=format&fit=crop&w=500&q=80",
    publishedBooksCount: 7,
  },
  {
    id: 32,
    ...
    image: "https://images.unsplash.com/photo-1507120410856-1f35574c3b45?auto=format&fit=crop&w=500&q=80",
    publishedBooksCount: 25,
  },
  {
    id: 33,
...
function AuthorCard({ author }) {
  return (
    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
      ...
      />
      <div className="p-4">
        <h3 className="font-semibold text-lg text-gray-900 mb-2">{author.name}</h3>
        <p className="text-gray-600 text-sm">
          {author.publishedBooksCount} {author.publishedBooksCount === 1 ? 'book' : 'books'} published
        </p>
      </div>
    </div>
  );
...
function AuthorGrid({ authors, gridCols = "grid-cols-2 md:grid-cols-4 lg:grid-cols-6" }) {
  return (
...
export default function AuthorsPage() {
  ...
  return (
    <div className="py-8 ">
      <h1 className="text-4xl font-bold mb-8 text-center text-gray-900">Our Authors</h1>
